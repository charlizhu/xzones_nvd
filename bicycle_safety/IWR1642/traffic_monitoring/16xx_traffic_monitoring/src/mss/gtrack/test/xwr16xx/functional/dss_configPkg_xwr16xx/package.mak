...
override PKGDIR = dss_configPkg_xwr16xx
...
package/%.xdc.inc package/%_dss_configPkg_xwr16xx.c package/%.defs.h: %.xdc $(PKGCFGS)
	@$(MSG) generating interfaces for package dss_configPkg_xwr16xx" (because $@ is older than $(firstword $?))" ...
...
package/cfg/dss_pe674.c package/cfg/dss_pe674.xdl: override _PROG_XSOPTS = -DMMWAVE_SDK_DEVICE=awr16xx -DMMWAVE_SDK_DEVICE_TYPE=xwr16xx
...
.PHONY: release,dss_configPkg_xwr16xx
ifeq (,$(MK_NOGENDEPS))
-include package/rel/dss_configPkg_xwr16xx.tar.dep
endif
package/rel/dss_configPkg_xwr16xx/dss_configPkg_xwr16xx/package/package.rel.xml: package/package.bld.xml
package/rel/dss_configPkg_xwr16xx/dss_configPkg_xwr16xx/package/package.rel.xml: package/build.cfg
package/rel/dss_configPkg_xwr16xx/dss_configPkg_xwr16xx/package/package.rel.xml: package/package.xdc.inc
package/rel/dss_configPkg_xwr16xx/dss_configPkg_xwr16xx/package/package.rel.xml: .force
	@$(MSG) generating external release references $@ ...
	$(XS) $(JSENV) -f $(XDCROOT)/packages/xdc/bld/rel.js $(MK_RELOPTS) . $@

dss_configPkg_xwr16xx.tar: package/rel/dss_configPkg_xwr16xx.xdc.inc package/rel/dss_configPkg_xwr16xx/dss_configPkg_xwr16xx/package/package.rel.xml
	@$(MSG) making release file $@ "(because of $(firstword $?))" ...
	-$(RM) $@
	$(call MKRELTAR,package/rel/dss_configPkg_xwr16xx.xdc.inc,package/rel/dss_configPkg_xwr16xx.tar.dep)


release release,dss_configPkg_xwr16xx: all dss_configPkg_xwr16xx.tar
clean:: .clean
	-$(RM) dss_configPkg_xwr16xx.tar
	-$(RM) package/rel/dss_configPkg_xwr16xx.xdc.inc
	-$(RM) package/rel/dss_configPkg_xwr16xx.tar.dep
